...
Big news everybody! I've finally completed my alternate implementation of "svn-dump-fast-export":http://barrbrain.github.com/svn-dump-fast-export/ in Perl. The key step was coming up with a simple algorithm that was of moderate time complexity and easy to prove correctness. I'll come back to that in a minute.
